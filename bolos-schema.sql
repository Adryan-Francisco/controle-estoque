-- Script para criar a tabela de bolos no Supabase
...
CREATE INDEX IF NOT EXISTS idx_bolos_disponivel ON bolos(disponivel);
...
-- Inserir alguns bolos de exemplo (opcional)
